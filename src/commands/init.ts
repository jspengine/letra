...
`;
		...
		const claudeMdContent = `# Letra Context — Claude Code Adapter
# Generated by letra init. Do not edit manually.
...
`;
		...
		const windsurfRulesPath = join(root, ".windsurfrules");
		const windsurfRulesContent = `# Letra Context — Windsurf Adapter
# Generated by letra init. Do not edit manually.
...
- Use formal tone in all generated content
`;
		writeFileSync(windsurfRulesPath, windsurfRulesContent);
		console.log(`    ${chalk.gray("Created")} .windsurfrules`);
