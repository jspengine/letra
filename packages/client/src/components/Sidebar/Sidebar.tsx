	...
	return (
		<ShadcnSidebar collapsible="icon" side="left">
			<SidebarHeader
				className={
					open
						? "flex flex-row items-center border-b px-4"
						: "flex flex-row items-center justify-center border-b px-0"
				}
				style={{
					borderColor: "var(--app-sidebar-border, var(--color-border))",
					height: "64px",
				}}
			>
				<div
				...
				>
					...
					<span
						...
						className={
							open
								? "truncate text-sm font-semibold text-[var(--color-text-primary)]"
								: "sr-only"
						}
					>
						Letra
