						...
						<div key={s} className="flex items-center">
							...
							{i < stepOrder.length - 1 && (
								<div
									...
									style={{
										background:
											i < currentIndex ? "var(--success)" : "var(--border)",
									}}
								/>
							)}
						</div>
				...
				>
					{stepOrder.map((s, i) => (
						<div
							...
							style={{
								width: i === 0 || i === stepOrder.length - 1 ? "auto" : undefined,
							}}
						>
							<span
								className={cn(
					...
					<div className="flex flex-col items-center text-center gap-6 pt-12 animate-fade-in">
						...
						<div>
							...
							<p className="text-muted-foreground text-base max-w-md">
								Seu hub de specs e contexto para IA. Organize seu fluxo de trabalho
								e mantenha seus agentes alinhados.
							</p>
						</div>
						...
						<div className="grid grid-cols-2 gap-4 text-sm w-full max-w-md">
							{[
								{
									icon: "edit" as const,
									text: "Escrever specs para suas features",
								},
								{ icon: "flow" as const, text: "Organizar o fluxo de trabalho" },
								{
									icon: "context" as const,
									text: "Alimentar agentes de IA com contexto",
								},
					...
					<div className="flex flex-col gap-6 pt-4 animate-fade-in">
						<div>
							...
							<p
								...
								style={{ color: "var(--muted-foreground)" }}
							>
								Selecione quais ferramentas de IA você usa. O Letra gerará
								adaptadores para cada uma.
							</p>
						</div>
						...
						<div className="flex flex-col gap-4">
							<div>
								...
								{TEMPLATES.filter((t) => t.id === selectedTemplate).map((t) => {
									const stages =
										selectedTemplate !== "personalizado" ? t.stages : [];
									return (
										<div key={t.id}>
											<div
