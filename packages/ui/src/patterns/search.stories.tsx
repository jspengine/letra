...
export const Default = () => <Search placeholder="Search item, spec, or agent..." className="w-80" />;
export const WithShortDebounce = () => <Search debounceMs={120} placeholder="Search quickly..." className="w-80" />;
export const Empty = () => <Search placeholder="No results yet..." className="w-80" />;
export const Loading = () => <Search placeholder="Indexing workspace..." className="w-80 opacity-80" />;
