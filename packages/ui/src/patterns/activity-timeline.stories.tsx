...
export const Default = () => (
	<ActivityTimeline className="w-full max-w-md">
		<TimelineItem
			...
			description="Pipeline 142 entered execution."
			timestamp="2 min ago"
			status="info"
		...
		<TimelineItem
			title="Tests passed"
			description="Unit and integration passed."
			timestamp="1 min ago"
			status="success"
		...
		<TimelineItem
			title="Build failed"
			description="SAST returned 2 critical findings."
			timestamp="now"
			status="error"
			icon={<Icon name="circle-x" size={16} />}
			action={<Badge variant="error">error</Badge>}
		/>
	</ActivityTimeline>
);
...
export const AgentOnly = () => (
	<ActivityTimeline className="w-full max-w-md">
		<TimelineItem
			title="Agent triage"
			description="Agent started classification."
			timestamp="3 min ago"
			status="agent"
...
export const Error = () => (
	<ActivityTimeline className="w-full max-w-md">
		<TimelineItem
			...
			description="Activity stream could not be loaded."
			timestamp="now"
			status="error"
			icon={<Icon name="circle-x" size={16} />}
			last
