...
- [ ] **Geração de Instruções**: `letra init` cria `CLAUDE.md` com referências a `.letra/context.md`, `.letra/constitution.md` e `.letra/glossary.md`.
- [ ] **Injeção de Contexto**: Ao iniciar sessão, o Claude Code injeta os arquivos `.letra/` no contexto.
